...
<img className='object-cover w-full h-full rounded-[18px]' src={profile} alt="Profile" />
...
<div className='flex gap-1 items-center justify-center'>
  ...
  <h2 className='px-3 text-white py-[6px] border rounded-full border-[#C9FE6E] inline-block'>Creative Developer</h2>
