...
const Testimonials = () => {
  ...
  return (
    <div className="w-full aspect-square rounded-[18px] font-inter bg-white dark:bg-black p-4 overflow-hidden relative">
      <h2 className="text-sm text-gray-400 dark:text-gray-500 font-medium p-3 mb-2">TESTIMONIALS</h2>
        ...
        <div className="animate-marquee-vertical">
          {duplicatedTestimonials.map((testimonial, index) => (
            <div 
              ...
              className="mb-4 tracking-[-0.5px] p-6 bg-white dark:bg-[#191919] rounded-lg flex flex-col items-end shadow-md mx-4"
            >
              <p className="text-gray-700 dark:text-gray-300 mb-2">{testimonial.quote}</p>
              <div className="flex items-center gap-2">
                <img 
                  src={testimonial.img} 
                  alt="" 
                  ...
                  className="rounded-full w-[24px] h-[24px] object-cover"
                />
                <p className="font-medium text-gray-900 dark:text-gray-200">{testimonial.author}</p>
              </div>
            </div>
          ))}
        </div>
